      ...
      <ContextMenu>
        ...
        <ContextMenuContent>
          ...
          <ContextMenuItem
            ...
            onClick={() => client?.user?.setStatus("online")}
          >
          ...
          <ContextMenuItem
            className="flex gap-2"
            onClick={() => client?.user?.setStatus("offline")}
          >
          ...
          <ContextMenuItem
            className="flex gap-2"
            onClick={() => client?.user?.setStatus("idle")}
          >
          ...
          <ContextMenuItem
            className="flex gap-2"
            onClick={() => client?.user?.setStatus("dnd")}
          >
          ...
          <ContextMenuItem
            className="flex gap-2"
            onClick={() => client?.user?.setStatus("coding")}
          >
          ...
          <ContextMenuItem
            className="flex gap-2"
            onClick={() => client?.user?.setStatus("streaming")}
          >
          ...
          <ContextMenuItem
            className="flex gap-2"
            onClick={() => client?.user?.setStatus("sleeping")}
          >
          ...
          <ContextMenuItem
            className="flex gap-2"
            onClick={() => client?.user?.setStatus("custom")}
          >
